                                ...
                                <li>
                                    ...
                                    <ul class="menu">
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="<?php echo site_url(); ?>img/avatar2.png" class="img-circle" alt="user image"/>
                                                </div>
                                                <h4>
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="<?php echo site_url(); ?>img/avatar.png" class="img-circle" alt="user image"/>
                                                </div>
                                                <h4>
                                                    Developers
                                ...
                                <form role="form">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="inputProductDesc" name='inputProductDesc'>
                                             <p class="help-block">Example Brown Leather</p>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputProductPrice">Product Price</label>
                                            <input type="text" class="form-control" id="inputProductPrice" name='inputProductPrice' placeholder="Password">
                                        </div>
                                        <div class="form-group">
                                            <label for="inputProductQuantity">Product Quantity</label>
                                            <input type="text" class="form-control" id="inputProductQuantity" name='inputProductQuantity' placeholder="Password">
                                        </div>
                                        <div class="form-group">
