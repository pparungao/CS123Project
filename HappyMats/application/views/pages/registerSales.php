    <body class="skin-blue">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <?php echo form_open('verifySales');?>
                                ...
                                <form role="form">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="inputSalesDescription">Description</label>
                                            <input type="text" class="form-control" id="inputSalesDescription" name='inputSalesDescription' placeholder="Description">
                                        </div>                                      
                                        <div class="form-group">
                                            <label>User ID</label>
                                            <select class="form-control" id='userid' name='userid'>
                                                <option value='001'>Frederick Matungon</option>
                                                <option value='002'>Seles Manguda</option>
                                                <option value='003'>Ference Guzman</option>
                                            </select>
                                        </div>

                                        <div class="form-group">
                                            <label for="inputSalesLocation">Location</label>
                                            <input type="text" class="form-control" id="inputSalesLocation" name='inputSalesLocation' placeholder="Location">
                                        </div>          
                                    </div><!-- /.box-body -->
