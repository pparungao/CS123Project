    <body class="skin-blue">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <?php echo form_open('verifyInitialSale');?>
                                ...
                                <form role="form">
                                    <div class="box-body">
                                        <div class="form-group">
                                        	 <label for="sales">Sales Records</label><br>
	                                         <?php                              
	                                            $sales = array();
	                                                foreach ($sale as $row){
	                                                    $sales[$row->id] = $row->description.'-'.$row->Location; 
	                                                   } 
	                                            echo form_dropdown('sales', $sales, 0);
	                                         ?>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputSalesQuantity">Quantity</label>
                                            <input type="text" class="form-control" id="inputSalesQuantity" name='inputSalesQuantity' placeholder="Quantity">
                                        </div>
                                        <div class="form-group">
                                            <label for="inputSalesPrice">Quantity</label>
                                            <input type="text" class="form-control" id="inputSalesPrice" name='inputSalesPrice' placeholder="Price">
                                        </div>
                                        <div class="form-group">
                                        	 <label for="records">Sales Records</label><br>
	                                         <?php                              
	                                            $products = array();
	                                                foreach ($tests as $row){
	                                                    $products[$row->ID] = $row->Name.'-'.$row->Description; 
	                                                   } 
	                                            echo form_dropdown('records', $products, 0);
	                                         ?>
                                        </div>
                                    </div><!-- /.box-body -->
