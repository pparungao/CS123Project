...
<html>
    <head>
        ...
        <!-- Ionicons -->
        <link href="<?php echo site_url(); ?>css/ionicons.min.css" rel="stylesheet" type="text/css" />
        <!-- Morris chart -->
        ...
        <!-- Date Picker -->
        <link href="<?php echo site_url(); ?>css/datepicker/datepicker3.css" rel="stylesheet" type="text/css" />
        <!-- Daterange picker -->
